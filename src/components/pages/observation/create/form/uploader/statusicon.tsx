...
export default function StatusIcon({ type }: { type?: AssetStatus }) {
  ...
  switch (type) {
    case AssetStatus.Uploaded:
      return (
        <div title={t("form.upload_status.uploaded")}>
          <svg
            className="icon"
            width="24"
            height="24"
    ...
    case AssetStatus.InProgress:
      return (
        <div title={t("form.upload_status.uploading")}>
          <svg
    ...
    case AssetStatus.Failed:
      return (
        <div title={t("form.upload_status.failed")}>
          <svg
            className="icon"
            width="24"
            height="24"
    ...
    default:
      return (
        <div title={t("form.upload_status.pending")}>
          <svg
            className="icon"
            width="24"
            height="24"
